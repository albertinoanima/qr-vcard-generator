...
formInline.on('input', () => {
  ...
  const phoneMobile = $('#phoneMobile').val();
  const phoneMobileVal = 'TEL%3BCELL%3A' + phoneMobile + '%0A';
  ...
  const qrURL = qrUrlStart + fnVal + nVal + posTitleVal + phoneMobileVal + phoneBusinessVal + phonePersonalVal + emailPersonalVal + emailBusinessVal + websiteVal + adrVal + coNameVal + qrUrlEnd;
